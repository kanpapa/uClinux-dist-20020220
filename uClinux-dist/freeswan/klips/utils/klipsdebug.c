...
char klipsdebug_c_version[] = "RCSID $Id: klipsdebug.c,v 1.41 2001/06/14 19:35:14 rgb Exp $";
...
usage(char * arg)
{
	fprintf(stdout, "usage: %s {--set|--clear} {tunnel|tunnel-xmit|xform|eroute|spi|radij|esp|ah|rcv|ipcomp|verbose}\n", arg);
