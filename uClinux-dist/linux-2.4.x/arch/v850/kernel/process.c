...
int kernel_thread (int (*fn)(void *), void *arg, unsigned long flags)
{
	...
	register unsigned long clone_flags __asm__ ("r6")
		= (long)flags | CLONE_VM;

	fs = get_fs ();
	set_fs (KERNEL_DS);

	/* Note -- this is basically an inline copy of the clone()
	   function.  */
	__asm__ __volatile__ (
		"addi  %1, r0, r12;"
		"trap  0;"	    /* clone syscall */
		"cmp   r10, r0;"    /* if not 0, we're the parent */
		"bne   1f;"	    /* ... so do nothing else. */
		"mov   %4, r6;"	    /* arg for FN */
		"jarl  .+4, r31;"   /* figure out current pc */
		"add   4, r31;"     /* and return addr for fun call */
		"jmp   %2;"	    /* In the child, call FN */
		"addi  %3, r0, r12;"/* and ... */
		"trap  0;"	    /* exit.  */
		"1:"		    /* parent thread jumps here */
		: "=r" (__ret)
		: "i" (__NR_clone), "r" (fn), "i" (__NR_exit), "r" (arg),
		  "r" (clone_flags)
		: "r1", "r5", "r6", "r7", "r8", "r9", "r10", "r11", "r12",
		"r13", "r14", "r15", "r16", "r17", "r18", "r19", "r31",
		"memory");
