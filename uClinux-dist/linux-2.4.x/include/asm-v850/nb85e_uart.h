...
#define NB85E_UART_ASIM_ADDR(n)	(NB85E_UART_ASIM_BASE_ADDR + 0x10 * (n))
...
#define NB85E_UART_ASIS_ADDR(n)	(NB85E_UART_ASIS_BASE_ADDR + 0x10 * (n))
...
#define NB85E_UART_ASIF_ADDR(n)	(NB85E_UART_ASIF_BASE_ADDR + 0x10 * (n))
...
#define NB85E_UART_RXB_ADDR(n)	(NB85E_UART_RXB_BASE_ADDR + 0x10 * (n))
#define NB85E_UART_RXB(n)	(*(volatile u8 *)NB85E_UART_RXB_ADDR(n))

/* UART transmit buffer register.  */
#define NB85E_UART_TXB_ADDR(n)	(NB85E_UART_TXB_BASE_ADDR + 0x10 * (n))
#define NB85E_UART_TXB(n)	(*(volatile u8 *)NB85E_UART_TXB_ADDR(n))

/* UART baud-rate generator control registers.  */
#define NB85E_UART_CKSR_ADDR(n)	(NB85E_UART_CKSR_BASE_ADDR + 0x10 * (n))
...
#define NB85E_UART_BRGC_ADDR(n)	(NB85E_UART_BRGC_BASE_ADDR + 0x10 * (n))
...
extern void nb85e_uart_cons_init (void);
