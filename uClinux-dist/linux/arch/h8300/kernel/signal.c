...
/* set up the return code... */
	put_user(0x7a170000,tframe); tframe++; /* add.l #24,sp */
	put_user(0x00181a80,tframe); tframe++; /* mov.l #119,er0 (sub.l er0,er0; mov.b #119,r0l)*/
	put_user(0xf8775700,tframe); tframe++; /* trapa #0 */
