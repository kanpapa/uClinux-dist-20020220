...
.PHONY : jffs.s19
jffs.s19:
	mkfs.jffs -d ../romfs -a big -o jffs.img 2> /dev/null
	mkfs.jffs -d ../romfs -a little -o jffs_pc.img 2> /dev/null
	srec_cat jffs.img -BIN -offset 0x01480000 > jffs.s19

.PHONY : all
all:	boot.s19 jffs.s19
...
archclean:
	@$(MAKEBOOT) clean
	rm -f linux.s19 romfs.s19 romfs.img boot.s19 system.s19 jffs.img jffs.s19 jffs_pc.img
