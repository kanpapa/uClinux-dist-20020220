...
static int get_version_bits(char *version, char *ver_long, char *letter, int *num);
...
int get_version_bits(char *version, char *ver_long, char *letter, int *num)
{
	char *tmp;
	int len;
	char *eptr;
	...
	ver_long[0] = '\0';
        ...
        if (version[strlen(version) - 1] == 'b'
            || version[strlen(version) - 1] == 'u'
            || version[strlen(version) - 1] == 'p'
            || version[strlen(version) - 1] == 'i')
                strcat(version, "0");
