...
static	AsnIdType	ifaceRetrieve (item)
...
static	MixStatusType	ifaceRelease (cookie)
...
static	MixStatusType	ifaceCreate (cookie, name, namelen, asn)
...
static	MixStatusType	ifaceDestroy (cookie, name, namelen)
...
static	AsnIdType	ifaceGet (cookie, name, namelen)
...
static	MixStatusType	ifaceSet (cookie, name, namelen, asn)
...
static	AsnIdType	ifaceNext (cookie, name, namelenp)
