...
static	MixStatusType	udpRelease (cookie)
...
static	MixStatusType	udpCreate (cookie, name, namelen, asn)
...
static	MixStatusType	udpDestroy (cookie, name, namelen)
...
static	MixStatusType	udpSet (cookie, name, namelen, asn)
